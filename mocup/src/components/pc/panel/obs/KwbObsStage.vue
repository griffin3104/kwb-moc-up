<template>
  <div class="kwb-obs-stage container-col box-one">
    <!-- タイトル領域 -->
    ...
    <div class="obs-current-area container-col">
      ...
      <div class="current-box container-row">
        <div class="upstream-container container-col box-one">
          <span class="move-obs">上流観測所</span>
          <span class="bnk_hght-item">堤防天端からの高さ</span>
          <div class="bnk_hght container-row">
            <span class="bnk_hght_value">-13.71</span>
            <span class="unit">m</span>
            <img src="/img/up_a.png" class="state">
            <img src="/img/excl.png" class="note">
          </div>
        </div>
        <div class="current-position container-col box-one">
          <span class="bnk_hght-item">堤防天端からの高さ</span>
          <div class="bnk_hght container-row">
            <span class="bnk_hght_value">-8.52</span>
            <span class="unit">m</span>
            <img src="/img/ud_a.png" class="state">
            <img src="/img/excl.png" class="note">
          </div>
        </div>
        <div class="downstream-container container-col box-one">
          <span class="move-obs">下流観測所</span>
          <span class="bnk_hght-item">堤防天端からの高さ</span>
          <div class="bnk_hght container-row">
            <span class="bnk_hght_value">-9.81</span>
            <span class="unit">m</span>
            <img src="/img/up_a.png" class="state">
            <img src="/img/excl.png" class="note">
          </div>
      ...
      <div class="contents-info container-col">
        ...
        <div class="current-info container-col" v-if="tabIndex === 0">
          <div class="obs-item-info container-row">
            ...
            <div class="value-info">{{stageObs.rsysName}}</div>
          </div>
          <div class="obs-item-info container-row">
            <div class="label">河川名</div>
            <div class="value-info">{{stageObs.rvrName}}</div>
          </div>
          <div class="obs-item-info container-row">
          ...
          <div class="obs-item-info container-row">
            ...
            <div class="value-info" style="color:blue">小河内&gt;&gt;</div>
          </div>
          <div class="obs-item-info container-row">
            <div class="label">洪水/周知/水防</div>
            <div class="value-info">-&frasl;-&frasl;○</div>
          </div>
          <div class="obs-item-info container-row">
            <div class="label">水防団待機水位</div>
            <div class="value-info">2.30m</div>
          </div>
          <div class="obs-item-info container-row">
            <div class="label">はん濫注意水位</div>
            <div class="value-info">2.80m</div>
          </div>
          <div class="obs-item-info container-row">
            <div class="label">避難判断水位</div>
            <div class="value-info">-</div>
          </div>
          <div class="obs-item-info container-row">
            <div class="label">はん濫危険水位</div>
            <div class="value-info">-</div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      master: [
        { label: "堤防天端からの高さ", key: "bnkHght", unit: "m" },
        { label: "時間雨量", key: "rnHr10m", unit: "mm/H" },
        { label: "累加雨量", key: "rnInc", unit: "mm/H" }
      ],
      history: {
        min10: [
          {
