<template>
  <div class="kwb-obs-snow container-col box-one">
    <!-- タイトル領域 -->
    ...
    <div class="obs-current-area container-col">
      ...
      <div class="current-box box-one container-col">
        <div class="current-data box-one container-col">
          <div class="current-title">積雪情報</div>
          <div class="box-one container-row">
            <div class="data-box box-one container-col">
              <div class="current-label border-btm">積雪深</div>
      ...
      <div class="contents-info container-col">
        ...
        <div class="current-info container-col" v-if="tabIndex === 0">
          <div class="obs-item-info container-row">
            ...
            <div class="value-info">石狩川管内</div>
          </div>
          <div class="obs-item-info container-row">
            <div class="label">水系名</div>
            <div class="value-info">石狩川</div>
          </div>
          <div class="obs-item-info container-row">
            <div class="label">管理者</div>
            <div class="value-info">国交省 札幌開発建設部</div>
          </div>
          <div class="obs-item-info container-row">
            <div class="label">所在地</div>
            <div class="value-info">北海道札幌市南区定山渓国有林2174林班(豊平峡ダムから南へ約8km)</div>
          </div>
          <div class="obs-item-info container-row">
        ...
        <div class="snow-info container-col" v-if="tabIndex === 1">
          <div class="snow-graph">積雪グラフ</div>
        </div>
  ...
  data() {
    return {
      ...
      titleInfo: {
        ...
        lonlat: "-",
        address:
          "北海道札幌市南区定山渓国有林2153林班(豊平峡ダムから南へ約13km)"
      },

      master: [
        { label: "積雪深", key: "snwdp", unit: "cm" },
        { label: "気温", key: "tmp", unit: "℃" }
      ],
      history: {
        min10: [
          {
